...
const Home = () => {
    ...
    const info = [
        ...
        {recurso: 'Controle remoto via aplicativo móvel',
         explicacao: 'Gerencie dispositivos pelo app'},
    ...
    <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center lg:justify-center">
        ...
        <section class="py-12 px-6 ">
            <div class="max-w-2xl mx-auto bg-gray-100  rounded-lg shadow-lg p-8 text-center ">
                <h2 class="text-3xl font-bold text-green-700 mb-6">Benefícios</h2>
            ...
            <div>
                <p class="mt-8 text-center text-xl text-gray-600 ">Junte-se a nós para tornar o mundo um lugar mais verde, uma luz de cada vez!</p>
            </div>
        </section>
        ...
        <section className="bg-gray-50 p-6" > 
           ...
           <div className="max-w-7xl mx-auto">
                <h2  className="text-3xl font-semibold text-green-700 mb-6 text-center">Feedback de Usuários</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {users.map(user => (
                        ...
                        <p className="mt-2 text-sm text-gray-500">{user.comment}</p>
